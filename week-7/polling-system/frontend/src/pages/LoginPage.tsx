          ...
          <Card className="overflow-hidden p-0">
            <CardContent className="grid p-0 md:grid-cols-2">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-muted-foreground text-balance">
                      Login to your Polling-System account
                    </p>
                  </div>
              ...
              <div className="bg-muted relative hidden md:block">
                <img
                  src="https://images.unsplash.com/photo-1720128401425-346f8b0c102c?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fHBvbGxpbmclMjBzeXN0ZW18ZW58MHx8MHx8fDA%3D"
                  alt="Image"
