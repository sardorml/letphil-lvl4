              ...
              {poll.options.map((option, index) => (
                <div key={index} className="flex items-center">
                  ...
                  <Label
                    ...
                    className="flex w-full items-center justify-center rounded-md px-3 py-2 text-sm font-medium ring-offset-background transition-all hover:bg-background hover:text-foreground peer-data-[state=checked]:bg-background peer-data-[state=checked]:text-foreground peer-data-[state=checked]:ring-2 cursor-pointer"
                  >
                    {option.text}
                  </Label>
                </div>
